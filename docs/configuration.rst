...
.. confval:: notfound_template
   ...
   Description: Template used to render the ``404.html`` generated by this extension.
...
.. confval:: notfound_context
   ...
   Description: Context passed to the template defined by ``notfound_template``.
...
.. confval:: notfound_pagename
   ...
   Description: Page name generated by the extension.
...
.. confval:: notfound_default_language
   ...
   Description: Language used as default to generate all the links to the resources.

   Default: ``'en'``

   Type: string

   Notes: All the links generated will have this prefix (e.g. ``/en/``).
   This setting works with ``notfound_default_version`` to create a prefix for all URLs.

.. confval:: notfound_default_version

   Description: Version used as default to generate all the links to the resources.

   Default: ``'latest'``

   Type: string

   Notes: All the links generated will have this prefix (e.g. ``/latest/``).
   This setting works with ``notfound_default_language`` to create a prefix for all URLs.

.. confval:: notfound_no_urls_prefix

   Description: Whether to skip URL prefixes.
